...
|-----|-------------|-------------------------------|
| S4 | Import, cleanse, transform data | Dropping and imputing missing data structures |
| K5 | Machine Learning workflows | Data preprocessing phase explicitly |
| B2 | Logical and analytical approach | Visualising and verifying the statistical impact of imputation |
