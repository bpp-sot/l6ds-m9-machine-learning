...
## What You Will Learn
- Understand the core concepts of outliers
- Apply outliers techniques using Python and pandas
...
Here is how you apply outliers in a standard workflow:
...
!!! tip "Workplace Tip"
    When applying outliers to your workplace data, ensure you document the transformations clearly. Stakeholders need to trust your methodology.
...
plt.title(f'Distribution after processing for Outliers')
plt.show()
```
...
## Summary
You have now learned the fundamentals of outliers. Remember to always start simple and iterate.
