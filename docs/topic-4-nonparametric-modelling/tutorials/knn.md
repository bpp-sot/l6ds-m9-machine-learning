...
## What You Will Learn
- Understand the core concepts of knn
- Apply knn techniques using Python and pandas
...
Here is how you apply knn in a standard workflow:
...
!!! tip "Workplace Tip"
    When applying knn to your workplace data, ensure you document the transformations clearly. Stakeholders need to trust your methodology.
...
plt.title(f'Distribution after processing for Knn')
plt.show()
```
...
## Summary
You have now learned the fundamentals of knn. Remember to always start simple and iterate.
