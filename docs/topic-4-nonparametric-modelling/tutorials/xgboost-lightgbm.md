...
## What You Will Learn
- Understand the core concepts of xgboost lightgbm
- Apply xgboost lightgbm techniques using Python and pandas
...
Here is how you apply xgboost lightgbm in a standard workflow:
...
!!! tip "Workplace Tip"
    When applying xgboost lightgbm to your workplace data, ensure you document the transformations clearly. Stakeholders need to trust your methodology.
...
plt.title(f'Distribution after processing for Xgboost Lightgbm')
plt.show()
```
...
## Summary
You have now learned the fundamentals of xgboost lightgbm. Remember to always start simple and iterate.
