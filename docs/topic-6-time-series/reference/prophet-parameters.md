# Reference: Prophet Parameters

This page contains quick-lookup information for prophet parameters.
...
When comparing approaches for prophet parameters, consider:
