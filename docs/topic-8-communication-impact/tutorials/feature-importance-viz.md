...
## What You Will Learn
- Understand the core concepts of feature importance viz
- Apply feature importance viz techniques using Python and pandas
...
Here is how you apply feature importance viz in a standard workflow:
...
!!! tip "Workplace Tip"
    When applying feature importance viz to your workplace data, ensure you document the transformations clearly. Stakeholders need to trust your methodology.
...
plt.title(f'Distribution after processing for Feature Importance Viz')
plt.show()
```
...
## Summary
You have now learned the fundamentals of feature importance viz. Remember to always start simple and iterate.
