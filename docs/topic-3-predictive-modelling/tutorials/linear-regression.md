...
- Apply linear regression techniques using Python and pandas
...
Here is how you apply linear regression in a standard workflow:
...
!!! tip "Workplace Tip"
    When applying linear regression to your workplace data, ensure you document the transformations clearly. Stakeholders need to trust your methodology.
...
plt.title(f'Distribution after processing for Linear Regression')
plt.show()
```
...
## Summary
You have now learned the fundamentals of linear regression. Remember to always start simple and iterate.
